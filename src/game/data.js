 ...
 * Single source of truth for Phaser build; paths use /assets/ (Vite public/).
 */
...
export const TILE_SPAWN_WEIGHTS = {
  blade: 22,
  ember: 22,
  tide: 22,
  spark: 22,
...
export const WEAK_TAKEN_MULT = 2;
export const CASCADE_MULT_BASE = 1.5;

export function pickWeightedTile(rng, weights) {
...
export const RIFT_CARD_DEFS = {
  ...
  bloodpact: {
    ...
    type: "chaos",
    description:
      "You deal double damage but take double damage from the monster.",
    hooks: {
...
export function svgDataUriTile(type) {
...
export function svgDataUriMonster() {
  const svg =
    '<svg xmlns="http://www.w3.org/2000/svg" width="256" height="256" viewBox="0 0 256 256">' +
...
export const ASSETS = {
  ...
  riftCardUrlCandidates(cardId) {
    return riftCardUrlCandidatesInner(cardId);
  },
  hunterUrlCandidates(hunterId) {
